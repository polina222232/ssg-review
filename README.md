...
## 👤 Автор
**Буренкова Полина Алексеевна**, группа [номер]
...
## 🧩 Компоненты Shoelace
- `sl-button`, `sl-icon-button`, `sl-icon`
- `sl-card`, `sl-badge`, `sl-tag`
- `sl-input`, `sl-textarea`, `sl-select`, `sl-option`, `sl-checkbox`
- `sl-drawer`, `sl-dialog`, `sl-tooltip`
- `sl-tab-group`, `sl-tab`, `sl-tab-panel`
- `sl-carousel`, `sl-carousel-item`
- `sl-breadcrumb`, `sl-breadcrumb-item`
- `sl-details`, `sl-alert`, `sl-divider`
- `sl-avatar`, `sl-rating`, `sl-progress-bar`
